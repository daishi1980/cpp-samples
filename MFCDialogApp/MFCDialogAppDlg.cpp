...
void CMFCDialogAppDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  システムがこの関数を呼び出します。
HCURSOR CMFCDialogAppDlg::OnQueryDragIcon()
{
